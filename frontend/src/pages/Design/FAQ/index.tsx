                ...
                <Page>
                    <MainPageContent>
                        ...
                        <p className={styles.FAQAnswer}>
                            ...
                            <em>OET</em> in July 2023. Any Bible translation
                        ...
                        <p className={styles.FAQAnswer}>
                            <a>
                                ...
                                the <em>Old</em>
                                is no longer relevant. Hence the <em>
                                    OET
                                </em>{' '}
                                actively tries to discard this terminology.
                            </a>
                        </p>
                        ...
                        <p className={styles.FAQAnswer}>
                            <a>
                                ...
                                context. Since the <em>OET</em> aims to try to
                                head in a new direction, we want to discourage
                                the use of small snippets out of context, and
                                this is one way that we can help do it.
                            </a>
                        </p>
                        <p>
                            [<Link href='#FAQTop'>Back to top</Link>]
                        ...
                        <p className={styles.FAQAnswer}>
                            <a>
                                ...
                                specifying who is the <em>he</em>. The{' '}
                                <em>OET</em> also includes grammatical and
                                semantic tagging. For example, if the text says{' '}
                                <em>gave it to him</em> the <em>OET</em> will
